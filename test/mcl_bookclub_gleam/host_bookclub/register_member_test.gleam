...
fn member(
  club_id: String,
  name: String,
) -> Result(register_member_v1.RegisterMember, dynamic.Dynamic) {
  register_member_v1.new(
    dict.from_list([
