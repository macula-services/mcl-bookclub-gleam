...
# Every case this script cannot read is a build: no before sha (a manual run),
# the all-zeros sha (a new branch or tag), a before sha that is not in the
# history (a force push), and an empty diff.
set -eu
