...
////
//// Same idempotent shape: INSERT OR REPLACE, the row carrying the applied
//// position, the status string from bookclub_status (Demon 68).
...
pub fn interested_in() -> List(String) {
  projection.interested_in(["bookclub_archived_v1"])
}
